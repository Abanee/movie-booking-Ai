...
const SocialProof = () => {
  ...
  const mockLiveActivity = [
    {
      id: 1,
      user: "Iyappan",
      avatar:"./assets/images/iyapps.jpg",
      action: "just booked",
      movie: "Dune: Part Two",
  ...
  const mockTrendingMovies = [
    ...
    },
    {
      id: 2,
      title: "Oppenheimer",
      poster: "https://image.tmdb.org/t/p/original/uXhV97FuB8OFt1pSEvIdf3Pnvgg.jpg",
      bookings: 1089,
      trend: "+18%",
      rating: 8.4,
      theaters: 142
    },
    {
      ...
      poster: "https://image.tmdb.org/t/p/original/jN1tz3Z10gUOdb11iPwQd6JBlms.jpg",
      bookings: 967,
      trend: "+31%",
      rating: 8.9,
      theaters: 134
    },
    {
      ...
      poster: "https://image.tmdb.org/t/p/original/kQWMSvX3wXfNPZV4a9zrNjYKcwp.jpg",
      bookings: 834,
      trend: "+15%",
      rating: 7.8,
      theaters: 128
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      const newActivity = {
        id: Date.now(),
        user: ["Abanee", "Subu", "Arun", "Jaya"][Math.floor(Math.random() * 4)],
        avatar: `${1500000000000 + Math.floor(Math.random() * 100000000)}`,
